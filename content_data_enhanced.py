"""
Enhanced Centralized Content Data Configuration
Contains all service details, industry data, and SEO metadata with in-depth content
Extracted from premium reference design with detailed service information
"""
...
SERVICE_DETAILS = {
    ...
    'enterprise-solutions': {
        ...
        'color': '#8b5cf6',
        'description': 'Integrate your enterprise systems with our robust integration platforms and solutions.',
        'short_description': 'Integrate your enterprise systems with our robust integration platforms and solutions.',
        'full_description': 'We specialize in enterprise system integration, helping organizations connect disparate systems, streamline workflows, and improve data flow across departments. Our solutions include ERP implementation, API integration, and data synchronization that ensure seamless operation of your entire business ecosystem.',
        'features': [
        ...
        'technologies': ['SAP', 'Oracle', 'Salesforce', 'MuleSoft', 'Apache Kafka', 'RabbitMQ'],
        'tech_description': 'Enterprise-grade integration platforms and tools for seamless connectivity.',
        'benefits': [
            'Improved Efficiency',
            'Data Consistency',
            'Reduced Manual Work',
        ...
        'pricing': 'ERP implementation: $50,000-$200,000+. Integration projects: $10,000+',
        'keywords': 'ERP, enterprise software, system integration',
        'seo_description': 'Enterprise software integration and ERP implementation services.',
        'seo_keywords': 'ERP implementation, enterprise integration, system integration'
    },
    
    'digital-transformation': {
        'id': 6,
        'name': 'Digital Transformation Consulting',
        'tagline': 'Transform your business digitally',
        'icon': 'fas fa-rocket',
        'color': '#10b981',
        'description': 'Strategic consulting to modernize your business processes and technology infrastructure.',
        'short_description': 'Strategic consulting to modernize your business processes and technology infrastructure.',
        'full_description': 'We guide organizations through comprehensive digital transformation journeys, helping them embrace modern technologies, streamline operations, and improve customer experiences. Our consultants bring deep industry expertise and proven transformation methodologies to ensure sustainable business growth.',
        'features': [
        ...
        'technologies': ['Cloud Platform', 'AI/ML', 'Analytics', 'Automation', 'Cybersecurity'],
        'tech_description': 'Comprehensive modern technology stack assessment and implementation.',
        'benefits': [
        ...
        'pricing': 'Consulting engagement: $5,000-$15,000 per month',
        'keywords': 'digital transformation, consulting, business modernization',
        'seo_description': 'Digital transformation consulting services to modernize your business.',
        'seo_keywords': 'digital transformation, business consulting, digital strategy'
    }
}
